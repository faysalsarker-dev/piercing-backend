const cancelMail = (name, date, slot, servicesName) => {
    return `
    <!DOCTYPE html>
    <html lang="sv">
    <head>
        ...
        <title>Avbokningsbekräftelse - Piercing Södermalm</title>
        <style>
            body {
    ...
    <body>
        <div class="container">
            <div class="header">
                ...
                <h1>Avbokningsbekräftelse</h1>
            </div>
            <div class="content">
                <h2>Hej, ${name}</h2>
                <p>Tyvärr har din bokning blivit avbokad. Här är detaljerna:</p>
                <div class="details">
                    <p><strong>Tjänst:</strong> ${servicesName}</p>
                    <p><strong>Datum:</strong> ${date}</p>
                    <p><strong>Tid:</strong> ${slot}</p>
                </div>
                <p>Om du har några frågor eller vill boka om, vänligen kontakta oss på:</p>
                <p><a href="mailto:piercingsodermalm@gmail.com">piercingsodermalm@gmail.com</a></p>
            </div>
            <div class="footer">
